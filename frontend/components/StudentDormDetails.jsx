...
const StudentDormDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchDormDetails = async () => {
      ...
      const sampleDorm = {
        ...
        address: "123 Avenue Mohammed V, Ain Diab, Casablanca 20000",
        city: "Casablanca",
        price: 2800,
        roomType: "studio",
        amenities: ["wifi", "kitchen", "laundry", "security", "parking", "ac"],
        rating: 4.5,
        reviews: 23,
        photos: [
        ...
        description: "Beautiful modern studio apartment located just 0.5km from Hassan II University campus. This fully furnished studio features a comfortable living space, modern kitchenette, private bathroom, and air conditioning. Perfect for students who want privacy and convenience in the heart of Casablanca.",
        landlord: {
          name: "Ahmed Benali",
  ...
  const getAmenityIcon = (amenity) => {
    switch (amenity) {
      ...
      case 'ac': return <Shield className="w-5 h-5" />;
      default: return null;
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-8">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">{dorm.rating} ({dorm.reviews} reviews)</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                {dorm.paymentOptions.map(option => (
                  <div
                    key={option.id}
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className={`p-2 rounded-lg ${
                        selectedPaymentOption === option.id ? 'bg-blue-100' : 'bg-gray-100'
                      }`}>
                        {option.icon}
                      </div>
              ...
              <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-xs text-yellow-800">
                  <strong>Important:</strong> All payments are arranged directly between student and landlord. 
                  RoastMyDorm is not responsible for financial transactions.
                </p>
              </div>
            </div>
...
export default StudentDormDetails;
